...
// ─────────────────────────────────────────────
// Helper — nav items berdasarkan role
// ─────────────────────────────────────────────
List<_NavDef> _buildNavItems(String role) {
  final items = [
  ...
  // Hanya Programmer yang lihat menu Admin
  if (role == 'Programmer') {
    items.add(
      _NavDef(Icons.developer_mode_rounded, 'Dev Tools', AppRoutes.admin),
    );
  }
  return items;
}
...
class ResponsiveScaffold extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final role     = AuthStorageService.getRole() ?? '';
      ...
      child: Column(children: [
        ...
        if (!compact)
          Obx(() => Padding(
                ...
                child: Column(children: [
                  // Dev Tools badge — hanya Programmer, non-compact
                  if (role == 'Programmer')
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Row(children: const [
                          ...
                          Icon(Icons.arrow_forward_ios_rounded,
                              size: 10, color: Color(0xFF0369A1)),
                        ]),
                      ),
                    ),
                  ...
                  Row(children: [
                    ...
                    Expanded(
                      child: Column(
                          ...
                          children: [
                            Text(
                              loginCtrl.loggedInUser.value ?? 'User',
                              style: const TextStyle(
                                  color: AppColors.textHead,
                                  fontSize: 12,
                                  fontWeight: FontWeight.w700),
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(12),
              color:
                  isActive ? AppColors.primaryLight : Colors.transparent,
            ),
            child: compact
                ? Center(
